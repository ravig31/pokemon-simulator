...
class TestTournament(BaseTest):
    ...
    def test_creation(self):
        """
        Tests the creation of a valid tournament and checks whether it starts
        """
    ...
    def test_random(self):
        """
        Tests the battle logic in a tournament and ensures it follows the correct sequence
        """
    ...
    def test_metas(self):
        """
        Tests the implementation of linked lists by checking its contents
        """
        RandomGen.set_seed(123456)
        t = Tournament(Battle(verbosity=0))
        t.set_battle_mode(0)
